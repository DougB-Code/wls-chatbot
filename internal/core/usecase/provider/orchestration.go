...
// internal/core/usecase/provider/orchestration.go
package provider
...
func NewOrchestrator(service *Service, secrets SecretStore, emitter ports.Emitter) *Orchestrator {
...
func (o *Orchestrator) emitProviderSwitchToast(previousActive, currentActive Provider) {
	...
	o.emitter.EmitToast(ports.ToastPayload{
		Type:    "info",
