// Implement the provider interface for Anthropic.
// internal/features/settings/adapters/provider/anthropic.go
package provider
...
func (a *Anthropic) toAnthropicMessages(messages []ProviderMessage) ([]anthropic.MessageParam, []anthropic.TextBlockParam) {
...
func (a *Anthropic) chatOnce(ctx context.Context, params anthropic.MessageNewParams) (<-chan Chunk, error) {
...
func (a *Anthropic) chatStreaming(ctx context.Context, params anthropic.MessageNewParams) (<-chan Chunk, error) {
...
func (a *Anthropic) textFromContentBlocks(blocks []anthropic.ContentBlockUnion) string {
...
func (a *Anthropic) toUsageStats(usage anthropic.Usage) *UsageStats {
...
func (a *Anthropic) mapStopReason(reason anthropic.StopReason) string {
...
func (a *Anthropic) newSDKClient() anthropic.Client {
...
func (a *Anthropic) wrapAnthropicError(err error) error {
	...
	if errors.As(err, &apiErr) {
		return &APIError{Code: apiErr.StatusCode, Message: apiErr.Error()}
	}
	return err
}
